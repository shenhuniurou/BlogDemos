...
public class BottomBarTab extends BottomBarItemBase {
    ...
    public BottomBarTab(@DrawableRes int bgResource, @NonNull int titleResource) {
     ...
     * @param titleResource resource for the title.
     */
    public BottomBarTab(@DrawableRes int iconResource, @DrawableRes int bgResource, @StringRes int titleResource) {
        this.iconResource = iconResource;
        this.bgResource = bgResource;
        this.titleResource = titleResource;
    }
